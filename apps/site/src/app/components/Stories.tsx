...
const STORIES: Story[] = [
  {
    head: "Elle a vu quelque chose que je ne voyais plus.",
    ...
    attr: "Dirigeant de PME — témoignage anonymisé",
  },
  {
    head: "Je ne me suis jamais sentie jugée.",
    ...
    attr: "Dirigeante de PME — témoignage anonymisé",
  },
  {
    head: "Elle m'a redonné le droit d'être ambitieuse.",
  ...
  return (
    <div className="mt-9">
      <div className="mx-auto max-w-[820px] rounded-lg border border-line bg-paper p-7 shadow-soft sm:p-10">
        <div
          className="font-serif text-[52px] leading-[0.6] text-brass"
          aria-hidden
        >
          &ldquo;
        </div>
